...
/** @addtogroup MINI51_XXX_EXPORTED_CONSTANTS SYS Exported Constants
  @{
*/    
/*---------------------------------------------------------------------------------------------------------*/
...
#define SYS_IS_BOD_RST()                (SYS->RSTSRC & SYS_RSTSRC_RSTS_BOD_Msk)        /*!< This macro get previos reset source is from Brown-out detect reset */
