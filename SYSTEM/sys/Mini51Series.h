...
/** @addtogroup MINI51_Definitions MINI51 Definitions
  This file defines all structures and symbols for Mini5x:
    - interrupt numbers
...
typedef struct
{
  ...
  __IO uint32_t  IRCTRIMISR;
     ...
     * |        |          |NMI_SEL[8] ¡V address 0x5000_380 (NMI interrupt source enable)
     */    
...
#define SYS_BODCR_BOD_VL_EXT_Pos                0                                       /*!< GCR BODCR: BOD_VL_EXT Position */
#define SYS_BODCR_BOD_VL_EXT_Msk                (1ul << SYS_BODCR_BOD_VL_EXT_Pos)       /*!< GCR BODCR: BOD_VL_EXT Mask     */
...
/** @addtogroup MINI51_CLK MINI51 Clock Controller
  Memory Mapped Structure for MINI51 Series Clock Controller
  @{
 */ 
/**
 ...
 */ 
/**
  * @brief GPIO configuration register map
  */   
typedef struct
{
...
/**
  * @brief GPIO bit access register map
  */  
typedef struct
{
...
#define GPIO_DBNCECON_BASE    (AHBPERIPH_BASE + 0x04180)    ///< GPIO Debounce register vase
...
#define GPIO                  ((GPIO_DBNCECON_T *) GPIO_DBNCECON_BASE)      ///< Pointer to GPIO debounce register structure
...
/** @addtogroup MINI51_IO_ROUTINE MINI5X I/O routines
